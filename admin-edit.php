    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="edit-product">
                ...
                <br />
                <form class="form" action="admin-edit-product.php" method="post">
                            ...
                            <td><label>Category</label>
                                ...
                                <select name="cid">
                                    ...
                                    <?php foreach ($cates as $item) { ?>
                                        <option name="cid" value="<?php echo $item["id"] ?>"><?php echo $item["name"] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td rowspan="11">
                                <h3>Bạn có muốn sửa sản phẩm này không?</h3>
                                <button>Có</button>
                                <button><a href="admin.php">Không</a></button>
                            </td>
                        </tr>
                        <tr>
                            <td><label>Avatar:</label><input type="file" name="avatar" value="<?php echo $result["avatar"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Image:</label><input type="file" name="img" value="<?php echo $result["img"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Name:</label><input name="name" value="<?php echo $result["name"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Discount:</label><input name="discount" value="<?php echo $result["discount"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Percent:</label><input name="percent" value="<?php echo $result["percent"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Size:</label><input name="size" value="<?php echo $result["size"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Color:</label><input name="color" value="<?php echo $result["color"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Gift:</label><input name="gift" value="<?php echo $result["gift"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Payment type:</label><input name="payment_type" value="<?php echo $result["payment_type"] ?>" /></td>
                        </tr>
                        <tr>
                            <td><label>Category name:</label><input name="category_name" value="<?php echo $result["category_name"] ?>" /></td>
                        </tr>
                    </table>
                </form>
            </div>
