    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="edit-product">
                ...
                <br />
                <form class="form user-edit" action="user-edit-product.php" method="post">
                    <input type="hidden" name="productid" value="<?php echo $result["productid"] ?>" />
                    <table>
                        <tr>
                            <td class="left"><label>Quantity:</label><input name="quantity" value="<?php echo $result["quantity"] ?>" /></td>
                            <td class="right">
                                <h3>Bạn có muốn thay đổi số lượng sản phẩm này không?</h3>
                                <button>Có</button>
                                <button><a href="cart.php">Không</a></button>
                            </td>
                        </tr>
                    </table>
                </form>
