...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            <!--  -->
            <div class="add-page-product">
                <h1>Thêm sản phẩm</h1>
                <br />
                <form class="form" action="admin-add-product.php" method="post">
                    ...
                    <table>
                        <tr>
                            ...
                            <td rowspan="11">
                                <h3>Bạn có muốn thêm sản phẩm này không?</h3>
                                <button>Có</button>
                                <button><a href="admin.php">Không</a></button>
                            </td>
                        </tr>
                        <tr>
                            <td><label>Avatar:</label><input type="file" name="avatar" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Image:</label><input type="file" name="img" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Name:</label><input name="name" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Discount:</label><input name="discount" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Percent:</label><input name="percent" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Size:</label><input name="size" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Color:</label><input name="color" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Gift:</label><input name="gift" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Payment type:</label><input name="payment_type" value="" /></td>
                        </tr>
                        <tr>
                            <td><label>Category name:</label><input name="category_name" value="" /></td>
                        </tr>
                    </table>
                </form>
            </div>
