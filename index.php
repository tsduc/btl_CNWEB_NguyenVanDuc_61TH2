    ...
    <div class="wrapper">
            ...
            <div class="header-bot">
                <section>
                    ...
                    <ul class="much-discount">
                        <?php $sql = "SELECT * FROM `grab_category` LIMIT 1 OFFSET  17"; ?>
                        <?php $results = select_one($sql); ?>
                        <li><a href="chuyen-muc.php?id=<?php echo $results["id"]; ?>"><?php echo $results["avatar"]; ?></a></li>
                        <?php $sql = "SELECT * FROM `grab_category` LIMIT 1 OFFSET  4"; ?>
                        <?php $results = select_one($sql); ?>
                        <?php $arruseful = (explode(" ; ", $results["avatar"])); ?>
                        <li><a href="chuyen-muc.php?id=<?php echo $results["id"]; ?>"><?php echo $arruseful[0]; ?></a></li>
                        <?php $sql = "SELECT * FROM `grab_category` LIMIT 1 OFFSET  2"; ?>
                        <?php $results = select_one($sql); ?>
                        <li><a href="chuyen-muc.php?id=<?php echo $results["id"]; ?>"><?php echo $results["avatar"]; ?></a></li>
                    </ul>
                </section>
        ...
        <div class="content">
            <div class="banner-top">
                <div class="banner-top-hiden"></div>
                <div class="banner-top-mid">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="images/690-300-690x300-30.png" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/690-300-690x300-1.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/690-300-690x300-17.png" alt="Third slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/690-300-690x300-12.png" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/690-300-690x300-14.png" alt="Third slide">
                            </div>
                        </div>
                ...
                <div class="banner-top-right">
                    <a href="#"><img src="images/Default-1-TV-254x254.png" alt=""></a>
                    <a href="#"><img src="images/Default-2-254x254.png" alt=""></a>
                    <a href="#"><img src="images/Default-3-254x254-2.png" alt=""></a>
                    <a href="#"><img src="images/Default-4-254x254.png" alt=""></a>
                    <a class="end" href="#"><img src="images/Default-5-262x96-524x192-3.jpg" alt="">
                </div>
            </div>
            <div class="banner-sale">
                <a href="#"><img src="images/banner-salecoll.png" alt=""></a>
            </div>
            <div class="banner-salemin">
                <a href="#"><img src="images/banner-cellmin.jpg" alt=""></a>
            </div>
            <?php $x = 0; ?>
            <?php $dem = 0; ?>
            <!-- sale everyday -->
            <div class="sale-everyday">
