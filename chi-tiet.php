                ...
                <div class="infor-product-right">
                    ...
                    <div class="promotion-buy">
                        <div class="promotion-buy-top">
                            ...
                            <div class="price-quatity">
                                <div>
                                    <?php $discount = $result['discount'] ?>
                                    <?php $percent = $result['percent'] ?>
                                    <?php $price = $discount * (1 - ($percent / 100)) ?>
                                    <strong><?php echo $price ?>₫</strong>
                                    <del><?php echo $discount ?>₫</del>
                                    -<?php echo $percent ?>%
                                </div>
                        ...
                        <div class="promotion-buy-bot">
                            ...
                            <div class="bot-buy">
                                <form class="form" action="user-add.php" method="post">
                                    <input type="hidden" name="id" value="<?php echo $result["id"] ?>" />
                                    <label class="control-label">Số lượng sản phẩm</label>
                                    <input name="quantity" class="form-control" value="1" min="1" max="1000" type="number">
                                    <button class="red">MUA NGAY GIÁ <?php echo $price ?>₫</button>
                                    <button class="blue">TRẢ GÓP QUA THẺ <span>Visa, Mastercard, JCB, Amex</span></button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="form" action="user-add.php" method="post">
                        <div class="buying-installment">
                            <input type="hidden" name="id" value="<?php echo $result["id"] ?>" />
                            <input name="quantity" class="form-control" value="1" min="1" max="1000" type="number">
                            <button class="buying">MUA NGAY</button>
                            <button class="buying-installment-left">MUA TRẢ GÓP 0%
                                <span>Duyệt hồ sơ trong 5 phút</span>
                            </button>
                            <button class="buying-installment-right">TRẢ GÓP QUA THẺ
